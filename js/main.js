...
function showAllTasks() {
    ...
    tasksList.insertAdjacentHTML('beforeend', "<br>Всего задач: " + (inProgressTasks + doneTasks));
    tasksList.insertAdjacentHTML('beforeend', "<br>Всего ВЫПОЛНЯЕМЫХ задач: " + inProgressTasks);
    tasksList.insertAdjacentHTML('beforeend', "<br>Всего СДЕЛАННЫХ задач: " + doneTasks);
}
...
function showInProcessTasks() {
    ...
    tasksList.insertAdjacentHTML('beforeend', "Всего ВЫПОЛНЯЕМЫХ задач: " + inProgressTasks);
}
...
function showDoneTasks() {
    ...
    tasksList.insertAdjacentHTML('beforeend', "Всего СДЕЛАННЫХ задач: " + doneTasks);
}
